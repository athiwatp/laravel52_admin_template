...
(function (factory) {
    ...
    Vue.component('my-subscriber', {
        template: '<div>' + '<h3>{{ cmpHeader }}</h3>' + '<p class="info-text">{{ cmpDescription }}</p>' + '<form>' + '<div class="input-group subscribe-form">' + '<input type="text" class="form-control input-lg" v-model="field.email" placeholder="{{ cmpFieldPlaceholder }}">' + '<span class="input-group-btn">' + '<button class="btn btn-primary btn-lg" @click="onSubscribeBtnClick()" :disabled="isButtonDisabled" type="button">' + '<i class="fa fa-envelope"></i>' + '</button>' + '</span>' + '</div>' + '</form>' + '</div>',
...
},{"jquery":1,"vue":3}],5:[function(require,module,exports){
'use strict';
...
},{"./components/my-subscriber.js":4,"jquery":1}],6:[function(require,module,exports){
"use strict";
...
},{"./Face/Core/scripts.js":5,"./Face/Custom/scripts.js":6}]},{},[7]);
