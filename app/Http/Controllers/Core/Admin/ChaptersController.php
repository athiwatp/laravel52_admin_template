...
class ChaptersController extends AdminController
{
     ...
     * @return void
     */
    public function __construct( ChaptersRepository $chapters, FileRepository $file )
    {
    ...
    public function indexAnnouncements()
    {
        ...
        $aParams = array(
            'aBreadcrumbs' => array(array('url' => '#', 'icon' => '<i class="fa fa-th-list"></i>', 'title' => Lang::get('chapters.lists.lists_chapters'))),
    ...
    public function indexGallery()
    {
        ...
        $aParams = array(
            'aBreadcrumbs' => array(array('url' => '#', 'icon' => '<i class="fa fa-clone"></i>', 'title' => Lang::get('chapters.lists.lists_chapters'))),
     ...
     * @return \Illuminate\Http\Response
     */
    public function indexUsefulLinks()
    {
        $sType = Config::get('constants.CHAPTER.USEFUL_LINKS');

        $aParams = array(
            'aBreadcrumbs' => array(array('url' => '#', 'icon' => '<i class="fa fa-qrcode"></i>', 'title' => Lang::get('chapters.lists.lists_chapters'))),
            'sTitle'    => Lang::get('chapters.lists.management_chapters_useful_links'),
            'sSubTitle' => Lang::get('chapters.lists.useful_links'),
            'sBoxTitle' => Lang::get('chapters.lists.lists_chapters_useful_links'),
            'sUrl'      => 'admin.chapter.usefulLinks',
            );
            ...
            'sContent' => $this->renderView('chapters.index', array(
                ...
                'aToolbar' => array(
                    ...
                    'edit' => array(
                        ...
                        'aParams' => array('id' => 'edit', 'disabled' => true, 'class' => 'edit-btn', 'data-url' => URL::route('admin.chapter.edit', array('id' => '%id%')) )
                    ),
                    'delete' => array(
                        'url' => '#',
                        'title' => Lang::get('table_field.toolbar.remove'),
                        'icon' => '<i class="fa fa-trash-o"></i>',
                        'aParams' => array('id' => 'delete', 'disabled' => true, 'class' => 'delete-btn', 'data-url' => URL::route('admin.chapter.destroy', array('id' => '%id%')) )
                    ),
                    'refresh' => array(
                        'url' => URL::route( $sUrl ),
                        'title' => Lang::get('table_field.toolbar.refresh'),
                        'icon' => '<i class="fa fa-refresh"></i>',
                        'aParams' => array('id' => 'refresh', 'class' => 'refresh-btn', 'data-url' => URL::route( $sUrl ) )
                    )
                )
            ))
        ));
    ...
    public function create( ChaptersRequest $request )
    {
        if ( $request->sType === Config::get('constants.CHAPTER.CHAPTER') ) {
            ...
            $sUrl        = 'admin.chapter.gallery';
        } elseif ( $request->sType === Config::get('constants.CHAPTER.ANNOUNCE') ) {
            $aBreadcrumbs = array(
                array('url' => URL::route('admin.chapter.announcements'), 'icon' => '<i class="fa fa-th-list"></i>', 'title' => Lang::get('chapters.lists.lists_chapters')),
            ...
            $aBreadcrumbs = array(
                array('url' => URL::route('admin.chapter.usefulLinks'), 'icon' => '<i class="fa fa-qrcode"></i>', 'title' => Lang::get('chapters.lists.lists_chapters')),
                array('url' => '#', 'icon' => '<i class="fa fa-plus"></i>', 'title' => Lang::get('chapters.lists.create_chapter_useful_links')));

            $formChapter = Lang::get('chapters.lists.management_chapters_useful_links');
            $formTitle   = Lang::get('chapters.lists.create_new_chapter_useful_links');
            $sUrl        = 'admin.chapter.usefulLinks';
        }
        ...
        return cForms::createForm( $this->getTheme(), array(
            ...
            'formButtons' => array(
                array(
                    ...
                    'type' => 'link',
                    'params' => array('url' => URL::route( $sUrl ), 'class'=>'btn-default')
                ),
                array(
            ...
            'formSwitcher' => array(
                array(
                    'title' => Lang::get('chapters.form.is_active'),
                    'name' => 'is_active'
                )
            ),
    ...
    public function store( ChaptersRequest $request )
    {
        ...
        if ( $request->sType === Config::get('constants.CHAPTER.CHAPTER') ) {
            ...
            $sUrl = 'admin.chapter.usefulLinks';
            $aMessage = Lang::get('chapters.message.store_useful_links');
        }
    ...
    public function edit( $id )
    {
        ...
        if ( $oData->type_chapter === Config::get('constants.CHAPTER.CHAPTER') ) {
        ...
        } elseif ( $oData->type_chapter === Config::get('constants.CHAPTER.ANNOUNCE') ) {
            $aBreadcrumbs = array(
                array('url' => URL::route('admin.chapter.announcements'), 'icon' => '<i class="fa fa-th-list"></i>', 'title' => Lang::get('chapters.lists.lists_chapters')),
            ...
            $aBreadcrumbs = array(
                array('url' => URL::route('admin.chapter.usefulLinks'), 'icon' => '<i class="fa fa-qrcode"></i>', 'title' => Lang::get('chapters.lists.lists_chapters')),
                array('url' => '#', 'icon' => '<i class="fa fa-pencil"></i>', 'title' => Lang::get('chapters.lists.editing_chapter_useful_links')));
            $sformChapter = Lang::get('chapters.lists.management_chapters_useful_links');
            $sformTitle   = Lang::get('chapters.lists.editing_chapter_useful_links');
            $sUrl         = 'admin.chapter.usefulLinks';
        }
