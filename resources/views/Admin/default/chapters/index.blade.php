...
<br>
<table id="example" class="datatables display responsive no-wrap" data-url="chapter" data-columns="{{ $sColumnsJson }}" data-edit-url="{{ URL::route('admin.chapter.edit', ['id' => '%id%']) }}" cellspacing="0" width="100%">
    <thead>
    <tr>
        <th>Id</th>
        <th>Title</th>
