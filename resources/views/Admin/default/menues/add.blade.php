...
<div class="row">
    <div class="panel panel-default">
        <div class="panel-heading">{{ Lang::get('table_field.menues.create_menu') }}</div>
        <div class="panel-body">
            <div class="col-lg-12">
                <div class="panel-body">
                    ...
                    {{ Html::link(URL::route('admin.menu.index'), Lang::get('table_field.lists.back'), array( 'class' => 'btn btn-outline btn-default') ) }}
                    {{ Form::close() }}
                </div>
            </div>
        </div>
